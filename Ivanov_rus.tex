...
\keywords{differential equations, asymptotic sustainability \ldots{}} % в конце списка точка не ставится
\end{abstract}
\end{englishtitle}
...
\keywords{дифференциальные уравнения, асимптотическая устойчивость \ldots} % в конце списка точка не ставится
\end{abstract}
...
\bibitem{A3} Alferov G., Ivanov G., Efimova P., Structural study of limited invariant sets of relay stabilized (Book Chapter), 2017, Mechanical systems: Research, Applications and Technology. P. 101-164.
...
\bibitem{A4} Alferov G.V., Korolev V.S., Polyakhova E.N., Kholshevnikov K.V. Modeling Problems of Dinamics and Development of Scientific Areas of Mechanics and Applied Mathematics. // Vestnik St. Petersburg University: Mathematics, 2023, 56(4), p. 470-477.
